...
if [ "${ARCH}" = "x86_64" ]; then
	...
	FVP_PKG_URL=https://developer.arm.com/-/cdn-downloads/permalink/FVPs-Architecture/FM-11.29
	FVP_PKG_NAME=FVP_Base_RevC-2xAEMvA_11.29_27_Linux64.tgz
...
# ARCH is "aarch64" on Ubuntu, or "arm64" on Mac OS
	...
	FVP_PKG_URL=https://developer.arm.com/-/cdn-downloads/permalink/FVPs-Architecture/FM-11.29
	FVP_PKG_NAME=FVP_Base_RevC-2xAEMvA_11.29_27_Linux64_armv8l.tgz
